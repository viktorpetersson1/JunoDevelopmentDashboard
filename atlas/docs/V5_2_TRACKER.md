...
| **T103**   | Platform-wide UX consistency + Ramp-grade visual pass (~9)             | P0  | ◐      | `3739cd4`                               | T103.11 dot-grid + sand tokens shipped. T103.1-.10 (format helpers, platform sweep) pending - the large remaining UI work.                                                                    |
