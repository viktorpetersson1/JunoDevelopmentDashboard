...
| ---------- | ---------------------------------------------------------------------- | --- | ------ | --------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| **T093**   | Canonical 9-line P&L + Summary-tab redesign (~6 pomos)                 | P0  | ◐      | —                                       | Foundation + Summary UI + Settings + rename all shipped. Only the new-project-wizard tax-edit field remains.         |
...
| T093.3     | Per-project tax rate → mig `0024` + Inputs field                       | P0  | ◐      | `e08dc6b` `d20a5fb`                     | Mig 0024 + read-path + Inputs display done. Editable field lives in the new-project wizard (remaining).              |
