...
| D-016 | Exit Pricing Framework (new module) | ⏸️ Backlog · awaiting proposal | Full spec at [backlog/exit-pricing-framework-v1.md](../docs/backlog/exit-pricing-framework-v1.md). New module feeding the financial model — three operating modes, comp library, low/base/high anchored output, market-rider vs market-maker classification. 8 open questions for Viktor in [backlog/exit-pricing-open-questions.md](../docs/backlog/exit-pricing-open-questions.md). No code until proposal approved. |
