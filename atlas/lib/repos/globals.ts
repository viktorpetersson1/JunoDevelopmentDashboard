...
export interface GlobalsRow {
  ...
  target_annual_npat_usd: number | string | null;
  fixed_overhead_annual_usd: number | string | null;
  project_time_to_npat_months: number | null;
