/**
 * T081.3 — Surface 01 — Index dashboard, now at /dashboard.
 *
 * Originally at `/` (see app/page.tsx for the redirect). Moved here to
 * make /dashboard the canonical post-login surface, eliminating the
 * `/sign-in?redirectTo=/` → `/` no-op cycle. See DECISIONS.md D-013.
 *
